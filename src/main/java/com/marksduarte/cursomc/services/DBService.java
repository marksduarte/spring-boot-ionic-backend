...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Marks Cliente", "markscliente@gmail.com", "36378912377", 
				passwordEncoder.encode("123456"), TipoCliente.PESSOAFISICA);
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		
		Cliente cli2 = new Cliente(null, "Marks Admin", "marksadmin@gmail.com", "82858144087", 
				passwordEncoder.encode("123456"), TipoCliente.PESSOAFISICA);
