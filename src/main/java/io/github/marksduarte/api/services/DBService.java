...
import io.github.marksduarte.api.domain.*;
import io.github.marksduarte.api.domain.enums.EstadoPagamento;
import io.github.marksduarte.api.domain.enums.Perfil;
import io.github.marksduarte.api.domain.enums.TipoCliente;
import io.github.marksduarte.api.repositories.*;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Marks Duarte", "marks@gmail.com", "36378912377", pe.encode("123"), TipoCliente.PESSOAFISICA);
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		cli1.addPerfil(Perfil.ADMIN);

		Cliente cli2 = new Cliente(null, "William Souza", "william@gmail.com", "31628382740", pe.encode("123"), TipoCliente.PESSOAFISICA);
